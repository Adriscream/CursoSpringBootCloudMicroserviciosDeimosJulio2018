...
import me.aboullaite.spring.cloud.springcloudcontractproducer.service.BookServiceImpl;
import me.aboullaite.spring.cloud.springcloudcontractproducer.web.BookController;

@RunWith(SpringRunner.class)
@SpringBootTest(classes= {BookController.class, BookServiceImpl.class},webEnvironment = SpringBootTest.WebEnvironment.MOCK)
